...
public class Student implements Steppable{
	...
	public void step(SimState state){
		...
		students.yard.setObjectLocation(this, new Double2D(sumForces)); //tener cuidado porque un location tiene que 
		//ser inmutable, razon por la cual aqui usamos Double2D
	}
